...
public class UI {
	...
	public static ChessPosition readChessposition(Scanner sc) {
		try {
			String chosenPosition = sc.nextLine();
			char column = chosenPosition.charAt(0);
			Integer row = Integer.parseInt(chosenPosition.substring(1));
			return new ChessPosition(column, row);
		} catch (RuntimeException e) {
			throw new InputMismatchException("Error reading chess." + " Valid values are from a1 to h8.");
		}
